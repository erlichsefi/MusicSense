...
public class DataShow extends WearableActivity {
    ...
    private static TextView
            ...
            HeartRateText, stepCounterText, timeDateText, sendToPhone,
...
//        H = new HeartRate(this);
        HeartRateText = (TextView) findViewById(R.id.textView3);
        HeartRateText.setText("Push To Start");
...
//        SendToPhone = new SendToPhone(this);
    ...
    public void StartRotationVector() {
        MOS.StartRotationVector();
    }

    public void StopRotationVector() {
        MOS.StopRotationVector();
    }
